<svelte:head>
  <title>Gran Canaria – Rannat | Matkaopas Espanjaan</title>
  <meta
    name="description"
    content="Opas Gran Canarian upeille rannoille. Esittelyssä Los Boliches, Playa del Castillo ja muut suosikit. Vinkit palveluista, aurinkotuoleista ja chiringuito-rantaravintoloista."
  />
</svelte:head>

<h1>Gran Canarian rannat</h1>

<p>
Gran Canaria tunnetaan erityisesti pitkistä ja hyvin hoidetuista hiekkarannoistaan.
...
<ul>
  ...
  <li>Rantabaarit ja <a href="/kanariansaaret/gran-canaria/ravintolat">chiringuito-ravintolat</a></li>
...
<p>
<a href="/kanariansaaret/gran-canaria/missa-asua">← Missä asua (alueet)</a> |
<a href="/kanariansaaret/gran-canaria/ravintolat">Ravintolat →</a>
</p>
