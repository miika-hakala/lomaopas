<script lang="ts">
  ...
  function saveProfile() {
    ...
    goto('/kanariansaaret/gran-canaria/lomasihteeri');
  }
</script>

<svelte:head>
  <title>Ota LomaSihteeri käyttöön – Gran Canaria</title>
</svelte:head>

<main class="onboarding-container">
  <h1>LomaSihteeri: Gran Canaria</h1>
  ...
  {#if step === 1}
    <section class="onboarding-step" aria-labelledby="step1-title">
      ...
      <p class="back-link"><a href="/kanariansaaret/gran-canaria">← {copy.onboarding1.btn_back}</a></p>
    </section>
  {/if}
