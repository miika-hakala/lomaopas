...
<svelte:head>
  <title>Gran Canaria – Päiväretket | Matkaopas Espanjaan</title>
  <meta
    name="description"
    content="Lähde päiväretkelle Gran Canariasta! Suosituimmat kohteet kuten Málaga, Mijas, Marbella ja Ronda. Vinkit liikkumiseen ja parhaat reitit autolla tai junalla."
  />
</svelte:head>
