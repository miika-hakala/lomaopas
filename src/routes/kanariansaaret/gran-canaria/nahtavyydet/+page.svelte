...
<svelte:head>
  <title>Gran Canaria – Nähtävyydet | Matkaopas Espanjaan</title>
  <meta
    name="description"
    content="Löydä Gran Canarian parhaat nähtävyydet. Esittelyssä Castillo Sohail, Bioparc, satama ja rantapaseo. Vinkit kävelyretkiin ja parhaisiin elämyksiin."
  />
</svelte:head>
