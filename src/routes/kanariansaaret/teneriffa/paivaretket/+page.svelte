...
<svelte:head>
  <title>Teneriffa – Päiväretket | Matkaopas Espanjaan</title>
  <meta
    name="description"
    content="Lähde päiväretkelle Teneriffasta! Suosituimmat kohteet kuten Málaga, Mijas, Marbella ja Ronda. Vinkit liikkumiseen ja parhaat reitit autolla tai junalla."
  />
</svelte:head>
