<script lang="ts">
  ...
  function saveProfile() {
    ...
    goto('/kanariansaaret/teneriffa/lomasihteeri');
  }
</script>

<svelte:head>
  <title>Ota LomaSihteeri käyttöön – Teneriffa</title>
</svelte:head>

<main class="onboarding-container">
  <h1>LomaSihteeri: Teneriffa</h1>
  ...
  {#if step === 1}
    <section class="onboarding-step" aria-labelledby="step1-title">
      ...
      <p class="back-link"><a href="/kanariansaaret/teneriffa">← {copy.onboarding1.btn_back}</a></p>
    </section>
  {/if}
