...
<svelte:head>
  <title>Teneriffa – Liikkuminen | Matkaopas Espanjaan</title>
  <meta
    name="description"
    content="Opas liikkumiseen Teneriffassa. Näin pääset lentokentältä ja käytät junaa, busseja ja takseja. Katso myös vinkit autonvuokraukseen ja päiväretkiin."
  />
</svelte:head>

<h1>Liikkuminen Teneriffassa</h1>

<p>
Teneriffassa liikkuminen on helppoa ja edullista. Kaupunki on melko tasainen ja
...
<p>
Málagan lentokentältä Teneriffaan pääsee usealla tavalla:
</p>
...
<p>
Paikallisjuna kulkee Teneriffan ja Málagan välillä useita kertoja tunnissa.
Junalla pääsee kätevästi myös lentokentälle ja naapurikaupunkeihin.
</p>

<p>
Teneriffassa on useita asemia, kuten keskustan ja Los Bolichesin alueilla.
</p>
...
on useita. Lue lisää <a href="/kanariansaaret/teneriffa/paivaretket">vinkkejämme päiväretkiin</a>.
</p>
