...
<svelte:head>
  <title>Teneriffa – Nähtävyydet | Matkaopas Espanjaan</title>
  <meta
    name="description"
    content="Löydä Teneriffan parhaat nähtävyydet. Esittelyssä Castillo Sohail, Bioparc, satama ja rantapaseo. Vinkit kävelyretkiin ja parhaisiin elämyksiin."
  />
</svelte:head>
