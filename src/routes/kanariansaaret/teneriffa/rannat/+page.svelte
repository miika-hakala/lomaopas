<svelte:head>
  <title>Teneriffa – Rannat | Matkaopas Espanjaan</title>
  <meta
    name="description"
    content="Opas Teneriffan upeille rannoille. Esittelyssä Los Boliches, Playa del Castillo ja muut suosikit. Vinkit palveluista, aurinkotuoleista ja chiringuito-rantaravintoloista."
  />
</svelte:head>
