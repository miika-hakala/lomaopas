<script lang="ts">
  ...
  function saveProfile() {
    ...
    goto('/espanja/malaga/lomasihteeri');
  }
</script>

<svelte:head>
  <title>Ota LomaSihteeri käyttöön – Málaga</title>
</svelte:head>

<main class="onboarding-container">
  <h1>LomaSihteeri: Málaga</h1>
  ...
  {#if step === 1}
    <section class="onboarding-step" aria-labelledby="step1-title">
      ...
      <p class="back-link"><a href="/espanja/malaga">← {copy.onboarding1.btn_back}</a></p>
    </section>
  {/if}
