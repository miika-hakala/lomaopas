<script lang="ts">
  ...
  function saveProfile() {
    ...
    goto('/espanja/torremolinos/lomasihteeri');
  }
</script>

<svelte:head>
  <title>Ota LomaSihteeri käyttöön – Torremolinos</title>
</svelte:head>

<main class="onboarding-container">
  <h1>LomaSihteeri: Torremolinos</h1>
  ...
  {#if step === 1}
    <section class="onboarding-step" aria-labelledby="step1-title">
      ...
      <p class="back-link"><a href="/espanja/torremolinos">← {copy.onboarding1.btn_back}</a></p>
    </section>
  {/if}
