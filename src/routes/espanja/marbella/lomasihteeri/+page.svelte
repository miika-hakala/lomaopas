...
<main class="dashboard-container">
  ...
  {:else if profile}
    <section class="profile-card" aria-labelledby="trip-title" data-testid="trip-card">
      ...
      <a href="/espanja/marbella/lomasihteeri/onboarding" class="edit-link">{copy.dashboard.edit_link}</a>
    </section>
  ...
  {:else}
    <section class="profile-card no-profile" aria-labelledby="no-profile-title">
      ...
      <a href="/espanja/marbella/lomasihteeri/onboarding" class="btn-primary">{copy.dashboard.no_profile_cta}</a>
    </section>
  {/if}

  <nav class="back-nav">
    <a href="/espanja/marbella">← {copy.dashboard.back_to_city}</a>
  </nav>
</main>
