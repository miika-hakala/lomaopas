...
<svelte:head>
	<title>{data.article.title} - {data.destination.name} - Lomaopas.fi</title>
	<meta
		name="description"
...
<div class="article-page">
	<Breadcrumbs items={[
		...
		{ label: data.destination.name, href: '/' + data.region.slug + '/' + data.destination.slug },
	...
	<GuideNav
		label="Takaisin {data.destination.name}-sivulle"
		href="/{data.region.slug}/{data.destination.slug}"
		direction="back"
	/>
</div>
